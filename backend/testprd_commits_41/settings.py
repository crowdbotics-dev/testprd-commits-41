"""
Django settings for testprd_commits_41 project.
...
ROOT_URLCONF = 'testprd_commits_41.urls'
...
WSGI_APPLICATION = 'testprd_commits_41.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprd_commits_41 API",
    "DESCRIPTION": "API documentation for testprd_commits_41 App",
    "VERSION": "v1",
}
